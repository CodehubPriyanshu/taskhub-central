...
<head>
    ...
    <title>User Dashboard - TaskHub Central</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li><a href="#" data-section="tasks">My Tasks</a></li>
        ...
        <div class="main-content">
            ...
            <div id="overview-section" class="content-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <h3>Overdue</h3>
                        <p class="stat-value" id="overdueTasksCount">0</p>
                    </div>
                </div>
            </div>
                ...
                <div class="profile-card">
                    <div class="profile-info">
                        <div class="info-item">
                            ...
                            <div class="info-value" id="profileName">N/A</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Email</div>
                            <div class="info-value" id="profileEmail">N/A</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Role</div>
                            <div class="info-value" id="profileRole">N/A</div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value" id="completedTasks">0</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Pending Tasks</div>
                            <div class="info-value" id="pendingTasks">0</div>
                        </div>
                    </div>
                </div>
            </div>
